...
public class MakeMyTrip_HomePage extends WebElement_Common_Usage{
	...
	public static void selecttrip(WebDriver browser,String expectedcountry) {
		List<WebElement> choosetrip = browser.findElements(By.xpath("//*[contains(@class,'fswTabs')]//li"));
		for(WebElement eachtrip : choosetrip) {
			String selecttrip = eachtrip.getText();
			if(selecttrip.equalsIgnoreCase(expectedcountry)) {
			eachtrip.findElement(By.xpath("//*[contains(@class,'tabsCircle')]")).click();
			break;
			}
